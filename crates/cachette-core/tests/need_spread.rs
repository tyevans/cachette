...
//! # References
//!
//! [^1]: ADR-0098, the choice is decided for each cell and each bucket of need, decisions D1 and D2. `docs/adrs/draft/adr-0098-the-choice-is-decided-for-each-cell-and-each-bucket-of-need.md`
