...
/// [^2]: ADR-0097, the choice is decided for each cell and each bucket of need, decision D3. `docs/adrs/draft/adr-0097-the-choice-is-decided-for-each-cell-and-each-bucket-of-need.md`
#[test]
