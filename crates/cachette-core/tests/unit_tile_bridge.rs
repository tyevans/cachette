...
fn the_world_answers_a_tile_after_the_step_rebuilds_the_bridge() {
    ...
    for (soldier, spawn) in &expected {
        ...
        // one tile at most.[^1]
        //
        // [^1]: ADR-0056, movement is tile-discrete and admitted by sort-then-admit, decision D1. `docs/adrs/accepted/adr-0056-movement-is-tile-discrete-and-admitted-by-sort-then-admit.md`
        let place = world
            .soldiers()
            .address(*soldier)
