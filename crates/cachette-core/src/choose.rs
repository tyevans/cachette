...
/// [^3]: ADR-0097, the choice is decided for each cell and each bucket of need, decision D1. `docs/adrs/draft/adr-0097-the-choice-is-decided-for-each-cell-and-each-bucket-of-need.md`
...
pub struct ChoiceExplanation {
    ...
    /// # References
    ///
    /// [^1]: ADR-0097, the choice is decided for each cell and each bucket of need. `docs/adrs/draft/adr-0097-the-choice-is-decided-for-each-cell-and-each-bucket-of-need.md`
...
impl NeedBuckets {
    ...
    /// # References
    ///
    /// [^1]: ADR-0097, the choice is decided for each cell and each bucket of need, decision D2. `docs/adrs/draft/adr-0097-the-choice-is-decided-for-each-cell-and-each-bucket-of-need.md`
    #[must_use]
