...
/// # References
///
/// [^1]: ADR-0107, the choice key holds a bounded class of the unit's own state, decision D1. `docs/adrs/draft/adr-0107-the-choice-key-holds-a-bounded-class-of-the-unit-state.md`
...
/// [^3]: ADR-0108, a unit returns by climbing a reach field seeded at every site of its faction, decision D1. `docs/adrs/draft/adr-0108-a-unit-returns-by-climbing-a-reach-field.md`
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Ranked {
...
/// # References
///
/// [^1]: ADR-0107, the choice key holds a bounded class of the unit's own state, decision D2. `docs/adrs/draft/adr-0107-the-choice-key-holds-a-bounded-class-of-the-unit-state.md`
...
/// # References
///
/// [^1]: ADR-0107, the choice key holds a bounded class of the unit's own state, decisions D1 and D2. `docs/adrs/draft/adr-0107-the-choice-key-holds-a-bounded-class-of-the-unit-state.md`
/// [^2]: ADR-0107, the choice key holds a bounded class of the unit's own state, decision D3. `docs/adrs/draft/adr-0107-the-choice-key-holds-a-bounded-class-of-the-unit-state.md`
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CarryClass {
...
/// [^2]: ADR-0107, the choice key holds a bounded class of the unit's own state, decision D5. `docs/adrs/draft/adr-0107-the-choice-key-holds-a-bounded-class-of-the-unit-state.md`
pub const OPTIONS: [OptionRow; OPTION_COUNT] = [
    OptionRow {
        ...
        // [^2]: Findings register, FND-191. `docs/FINDINGS.md`
        // [^3]: ADR-0107, the choice key holds a bounded class of the unit's own state, decision D5. `docs/adrs/draft/adr-0107-the-choice-key-holds-a-bounded-class-of-the-unit-state.md`
        name: "deliver",
        drive: Drive::Met,
        ranked: Ranked::Carry,
        gathers: None,
...
pub struct ChoiceExplanation {
    ...
    /// # References
    ///
    /// [^1]: ADR-0107, the choice key holds a bounded class of the unit's own state, decision D4. `docs/adrs/draft/adr-0107-the-choice-key-holds-a-bounded-class-of-the-unit-state.md`
...
/// [^2]: ADR-0107, the choice key holds a bounded class of the unit's own state, decision D1. `docs/adrs/draft/adr-0107-the-choice-key-holds-a-bounded-class-of-the-unit-state.md`
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
