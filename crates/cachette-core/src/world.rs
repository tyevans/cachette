...
pub struct World {
    ...
    /// # References
    ///
    /// [^1]: ADR-0108, a unit returns by climbing a reach field seeded at every site of its faction, decision D1. `docs/adrs/draft/adr-0108-a-unit-returns-by-climbing-a-reach-field.md`
    returns: ReturnField,
    ...
    /// # References
    ///
    /// [^1]: ADR-0107, the choice key holds a bounded class of the unit's own state, decision D3. `docs/adrs/draft/adr-0107-the-choice-key-holds-a-bounded-class-of-the-unit-state.md`
    carry_mark: Amount,
                ...
                scope.spawn(move || {
                    ...
                    for cell in start..end {
                        ...
                        for unit in units {
                            ...
                            //
                            // [^17]: ADR-0107, the choice key holds a bounded class of the unit's own state, decision D1. `docs/adrs/draft/adr-0107-the-choice-key-holds-a-bounded-class-of-the-unit-state.md`
            ...
            scope.spawn(move || {
                *slot = chunk
                    ...
                    .filter_map(|soldier| {
                        ...
                        //
                        // [^18]: ADR-0108, a unit returns by climbing a reach field seeded at every site of its faction, decision D1. `docs/adrs/draft/adr-0108-a-unit-returns-by-climbing-a-reach-field.md`
