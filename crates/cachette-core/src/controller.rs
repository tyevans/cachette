...
impl Choice {
    ...
    /// [^3]: ADR-0197, a verb names a place by a cell of the egocentric frame the observation publishes, decision D2. `docs/adrs/draft/adr-0197-a-verb-names-a-place-by-a-cell-of-the-egocentric-frame.md`
    #[must_use]
