...
[^31]: ADR-0149, a faction's trade board is simulated state that any faction may read. `docs/adrs/accepted/adr-0149-a-factions-trade-board-is-simulated-state-that-any-faction-may-read.md`
