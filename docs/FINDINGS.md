...
the tiles they took from.[^FND104A] Recovery is therefore the ageing away of a
...
records later, and only because somebody asked.[^FND104B]
...
[^FND104A]: ADR-0072, a tile stock is generated, and only what was taken is stored. `docs/adrs/accepted/adr-0072-a-tile-stock-is-generated-and-only-what-was-taken-is-stored.md`
[^FND104B]: PRD-0018, a depleted deposit comes back. `docs/product/shaped/prd-0018-a-depleted-deposit-comes-back.md`
