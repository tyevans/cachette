...
### FND-582 — Two tests asserted that a value stands still, and a rule neither test models moves it
...
its option row and deliver at all.[^F582B]
...
[^F582B]: Findings register, FND-572. `docs/FINDINGS.md`
