...
### FND-579 — The way between two settlements was believed to be planned, and the branch that planned it could never run
...
### FND-580 — A way was believed to stand wherever a unit walks
