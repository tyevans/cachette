...
### DEC-097 — How wide is a need bucket in the choice?
...
words, and named the three things a fixture would need.[^D097C]
...
the reference table holds the value a world starts with.[^D097B]
...
[^D097E]: Review of ADR-0096, correction 1. The review artefact sits on the branch that holds it, so this branch cannot resolve its path and the citation names it instead.
