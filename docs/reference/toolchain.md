...
[^9]: Findings register, FND-284. `docs/FINDINGS.md`
[^10]: Decisions register, DEC-107. `docs/DECISIONS.md`
[^11]: Backlog item 0293, name the reassociating methods in the lint. `docs/backlog/proposed/0293-name-the-reassociating-methods-in-the-lint.md`
