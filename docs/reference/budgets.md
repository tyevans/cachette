...
| Terrain height range | 0 to 1500 m | BLK-156 | Owner decision, 7 September 2026, replacing 4000 m chosen the day before. The terrain declares a height as a unit fraction and this is what the whole fraction is worth. **The first figure was chosen for the alpine contrast and against no measurement of where this terrain puts its land.** A probe then found the land of this world standing at 41 to 69 percent of its own range, so 4000 m put the mean land near 2000 m against a published mean near 800 m for the Earth, and the published lapse rate took 11 to 18 degrees off every land cell. This figure puts the mean land near 800 m. **The cost is that no ground in the world reaches a permanent snow line at any latitude**, and the highest ground is a high hill rather than a mountain. The owner traded the alpine contrast away knowingly. **A world states the range, in the way a world states its latitude span**, so a world that wants taller ground changes a value and not the physics |
