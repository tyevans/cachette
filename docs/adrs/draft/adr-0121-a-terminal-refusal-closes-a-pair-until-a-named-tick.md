# ADR-0121: A terminal refusal closes an ordered pair until a named tick
...
[^2]: ADR-0122, a contract moves a quantity only when a unit carries it onto the ground of the other party, decision D4. `docs/adrs/draft/adr-0122-a-contract-moves-a-quantity-only-when-a-unit-carries-it.md`
