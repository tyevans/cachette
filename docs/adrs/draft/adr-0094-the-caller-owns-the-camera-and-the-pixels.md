...
register already holds, with its own item.[^6] Moving the boundary does not
...
[^6]: Backlog item 0210, generate the ground of a drawn tile once. `docs/backlog/proposed/0210-generate-the-ground-of-a-drawn-tile-once.md`
