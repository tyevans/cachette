...
| 0063 | A need is a rate with a threshold, and crossing it is a fact | Draft | 0032, 0062 | 15, `draft/adr-0063-a-need-is-a-rate-with-a-threshold-and-crossing-it-is-a-fact.md` |
