...
| 0197 | A verb names a place by a cell of the egocentric frame the observation publishes. Changes ADR-0184 D3 and replaces it: that clause forbids every place, and it does so on the premise that a place is an index into the world extent. A cell of the egocentric frame is bounded by a constant, so the premise does not reach it. The constraint underneath D3 stands, and every other decision of ADR-0184 stands | Draft | 0004, 0040, 0075, 0144, 0154, 0176, 0184, 0192, 0195 | `draft/adr-0197-a-verb-names-a-place-by-a-cell-of-the-egocentric-frame.md` |
