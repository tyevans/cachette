...
| 0176 | An action integer is a mixed radix over the argument positions each verb declares. Changes ADR-0154 D4, the fixed verb, target and magnitude factorisation, which the controller's choice enumeration never had; the rest of ADR-0154 D4 and every other decision of ADR-0154 stand | Draft | 0075, 0144, 0149, 0154, 0156, 0158, 0159 | `draft/adr-0176-an-action-integer-is-a-mixed-radix-over-the-positions-a-verb-declares.md` |
