...
| 0154 | The observation and the action of a faction are schema-declared bounded tables the engine owns | Draft | 0002, 0004, 0006, 0022, 0040, 0096, 0111, 0144, 0146, 0148, 0149 | `draft/adr-0154-the-observation-and-the-action-of-a-faction-are-schema-declared-bounded-tables.md` |
| 0155 | A batch of worlds steps in one call, in index order | Draft | 0001, 0004, 0009, 0040, 0042, 0047, 0096, 0154 | `draft/adr-0155-a-batch-of-worlds-steps-in-one-call-in-index-order.md` |
