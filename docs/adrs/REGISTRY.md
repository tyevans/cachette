...
| 0182 | The temperature a cell is driven toward is a published energy balance, and the poleward transport is imposed. **Nothing implements it: BLK-156 holds the missing unit for the ground term.** Changes ADR-0166 D2, the clause that gives the sun term a written-down swing, and ADR-0177 D3 and D5, the belt and season amplitudes and the normaliser that maps their sum onto that swing; the other decisions of both stand | Draft | 0001, 0002, 0004, 0005, 0009, 0140, 0160, 0162, 0166, 0177 | `draft/adr-0182-the-temperature-a-cell-is-driven-toward-is-a-published-energy-balance.md` |
