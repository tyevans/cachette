...
| 0146 | A faction relation is one signed integer per ordered pair, and a pass reads a threshold. Changes ADR-0053 D7: a relation row holds a signed integer and not a mask; the other decisions of ADR-0053 stand. Changes ADR-0121 D1: the contest is gated on the war band | Accepted | 0001, 0002, 0004, 0006, 0053, 0121, 0126, 0133, 0142, 0144, 0145 | `accepted/adr-0146-a-faction-relation-is-one-signed-integer-per-ordered-pair-and-a-pass-reads-a-threshold.md` |
...
| 0149 | A faction's trade board is simulated state that any faction may read | Accepted | 0002, 0004, 0144, 0147 | `accepted/adr-0149-a-factions-trade-board-is-simulated-state-that-any-faction-may-read.md` |
...
| 0151 | An upgrade is a category with a ground fit and a level, and a build order names the category | Accepted | 0002, 0004, 0088, 0090, 0144, 0145 | `accepted/adr-0151-an-upgrade-is-a-category-with-a-ground-fit-and-a-level.md` |
| 0152 | A faction plans its roads and zones with one solver, and a unit builds only what the plan zones | Accepted | 0001, 0004, 0005, 0090, 0144, 0150, 0151 | `accepted/adr-0152-a-faction-plans-its-roads-and-zones-with-one-solver.md` |
| 0153 | A tile's lease follows the units that stand on it, and a lease at the claim threshold outranks the reach of a city. Changes ADR-0150 D1, the order that gives a tile its holder; the other decisions of ADR-0150 stand | Accepted | 0002, 0004, 0009, 0053, 0111, 0146, 0150 | `accepted/adr-0153-a-tiles-lease-follows-the-units-that-stand-on-it.md` |
...
| 0156 | A faction's option weights are policy, set through one verb | Accepted | 0002, 0003, 0004, 0023, 0040, 0053, 0064, 0096, 0098, 0109, 0144, 0150, 0152, 0153, 0154 | `accepted/adr-0156-a-factions-option-weights-are-policy-set-through-one-verb.md` |
...
| 0158 | A site builds a typed unit from a bounded queue its store pays for | Accepted | 0004, 0009, 0040, 0062, 0096, 0120, 0144, 0150, 0154, 0156, 0157 | `accepted/adr-0158-a-site-builds-a-typed-unit-from-a-bounded-queue-its-store-pays-for.md` |
| 0159 | A project order names one category for each unit and one seed set for the faction, and the field decides where a unit arrives. Changes ADR-0152 D5, the per-unit assignment; the other decisions of ADR-0152 stand | Accepted | 0001, 0004, 0040, 0091, 0095, 0110, 0125, 0144, 0152 | `accepted/adr-0159-a-project-order-names-one-category-and-one-seed-set.md` |
...
| 0165 | The wealth bar stands above what one settlement can hold. Superseded by ADR-0173, which gives the path no reader at all, so how high the bar stands decides nothing. Its change to ADR-0148 D3 lapses with it | Superseded | 0173 | `draft/adr-0165-the-wealth-bar-stands-above-what-one-settlement-can-hold.md` |
...
| 0173 | The wealth or wonder path has no reader, and no game ends on it. Supersedes ADR-0165. Superseded by ADR-0174, which keeps the stock clause retired and gives the wonder a reader of its own | Superseded | 0002, 0148, 0165 | `draft/adr-0173-the-wealth-or-wonder-path-has-no-reader.md` |
...
| 0176 | An action integer is a mixed radix over the argument positions each verb declares. Changes ADR-0154 D4, the fixed verb, target and magnitude factorisation, which the controller's choice enumeration never had; the rest of ADR-0154 D4 and every other decision of ADR-0154 stand | Accepted | 0075, 0144, 0149, 0154, 0156, 0158, 0159 | `accepted/adr-0176-an-action-integer-is-a-mixed-radix-over-the-positions-a-verb-declares.md` |
| 0177 | The row axis of a world is a latitude that the world states, and the weather never reads a raw row. Changes ADR-0166 D2, the clause that reads the row as a distance from where the sun stands; the other decisions of ADR-0166 stand | Draft | 0001, 0002, 0004, 0009, 0140, 0160, 0161, 0162, 0166 | `draft/adr-0177-the-row-axis-of-a-world-is-a-latitude-that-the-world-states.md` |
| 0180 | A site changes hands or the taker destroys it, and what stands there follows the ground. Changes ADR-0150 D1, which reads the faction of a city as the faction that founded it; every other decision of ADR-0150 stands | Draft | 0001, 0004, 0006, 0014, 0053, 0066, 0150, 0151, 0153, 0157, 0158, 0164, 0181 | `draft/adr-0180-a-site-changes-hands-or-the-taker-destroys-it.md` |
| 0183 | Condensed water is carried state that falls on a published timescale, so a storm forms in one cell and rains in another. Changes ADR-0162 D2, which puts the water the air sheds onto the ground of the cell that shed it; the other decisions of ADR-0162 stand | Draft | 0001, 0002, 0004, 0140, 0141, 0160, 0161, 0162 | `draft/adr-0183-condensed-water-is-carried-state-that-falls-on-a-published-timescale.md` |
| 0182 | The temperature a cell is driven toward is a published energy balance, and the poleward transport is imposed. Changes ADR-0166 D2, the clause that gives the sun term a written-down swing, and ADR-0177 D3 and D5, the belt and season amplitudes and the normaliser that maps their sum onto that swing; the other decisions of both stand | Draft | 0001, 0002, 0004, 0005, 0009, 0140, 0160, 0162, 0166, 0177 | `draft/adr-0182-the-temperature-a-cell-is-driven-toward-is-a-published-energy-balance.md` |
| 0181 | A faction that holds no site and no unit leaves the game, and its ground returns to nobody. Changes ADR-0148 D1, the clause that lets every faction of a world reach a win reader; the other decisions of ADR-0148 stand | Draft | 0001, 0004, 0006, 0014, 0053, 0066, 0148, 0150, 0153, 0164, 0180 | `draft/adr-0181-a-faction-that-holds-no-site-and-no-unit-leaves-the-game.md` |
| 0184 | A verb narrows the set it acts on by a bounded categorical position, and never by a list of identities. Extends ADR-0176 D1, which lets a verb declare argument positions but states no rule for what may be one; every decision of ADR-0176 stands, and the verb set of D4 does not change | Draft | 0004, 0040, 0053, 0120, 0144, 0145, 0150, 0151, 0154, 0156, 0158, 0176 | `draft/adr-0184-a-verb-narrows-its-set-by-a-bounded-categorical-position.md` |
| 0190 | Ground that carries ice stays at the melting point until the ice is gone, and the freezing a cell has taken is carried state. Extends ADR-0182, which names the missing term; every decision of ADR-0182 stands | Draft | 0001, 0002, 0004, 0005, 0009, 0140, 0160, 0162, 0166, 0177, 0182 | `draft/adr-0190-ground-that-carries-ice-stays-at-the-melting-point-until-the-ice-is-gone.md` |
| 0191 | The workers of a batch outlive the step, and the caller states how many there are. Extends ADR-0155 D4, which makes the worker count a parameter and says nothing about the life of a worker; every decision of ADR-0155 stands | Draft | 0001, 0004, 0009, 0040, 0042, 0047, 0155 | `draft/adr-0191-the-workers-of-a-batch-outlive-the-step.md` |
...
| 0193 | A faction's observation names another faction by a position relative to the reader. Superseded by ADR-0195, which removes every field that holds one position for each faction, so the relative order this record states governs nothing. Its rule stays in the code until the layout of ADR-0195 replaces it | Superseded | 0053, 0146, 0149, 0154 | `draft/adr-0193-an-observation-names-another-faction-by-a-position-relative-to-the-reader.md` |
| 0194 | A generation is scored one episode at a time, and combined in candidate order | Draft | 0001, 0040, 0154, 0155 | `draft/adr-0194-a-generation-is-scored-in-shards.md` |
| 0195 | The observation of a faction is a fixed-width scale-free table in an egocentric frame. Supersedes ADR-0193, whose relative seat order is replaced by order statistics and a fixed token set. Changes ADR-0154 D2 and replaces it: it narrows the length from a function of the world parameters to a constant, and it withdraws the clause that forbids a pass over the tiles in favour of a cost bound on the observed area. The rest of ADR-0154 stands | Draft | 0001, 0002, 0004, 0017, 0022, 0023, 0024, 0040, 0053, 0059, 0096, 0154, 0193 | `draft/adr-0195-the-observation-of-a-faction-is-a-fixed-width-scale-free-table.md` |
| 0196 | A reward is a bounded weighted objective vector, and one generation scores one objective. Extends ADR-0195 D2, which makes every published value scale-free but states no rule for the terms a reward builds from them | Draft | 0001, 0154, 0155, 0194, 0195 | `draft/adr-0196-a-reward-is-a-bounded-weighted-objective-vector.md` |
| 0197 | The approach relaxation reaches a stated distance by a frontier walk, and not by a fixed pass count. **The claim is the question this number reserves, and nothing has decided it.** The fine relaxation runs a pass count derived from the block edge, so one entry sweeps the whole block once for every pass. A unit-weight frontier walk capped at the same distance gives the identical answer in a single pass, and the same code path is the largest cost of three separate stages of a frame. The forces are that the walk turns a fixed iteration count into a data-dependent one, and that it reads what the field holds in order to choose where to go next. ADR-0005 D1 requires a solver to run a fixed iteration count, and ADR-0087 D1 forbids a branch in a solve that reads what the field holds. The change is therefore a decision and not a patch | Proposed | 0001, 0004, 0005, 0087, 0091, 0172 | 39 |
| 0198 | A learner model predicts the outcome of the episode, and it fits on episodes the trainer already ran. **The claim is the question this number reserves, and nothing has decided it.** Every learner so far maps one observation to one action integer, and an evolution strategy scores each one by a whole episode. A report proposes the first model that is not a policy: a model that reads the observation and predicts, for each row of the action table, whether the reader's seat wins. The forces are that the outcome of an episode labels every decision in it rather than the episode alone, that the label carries no reduction of a window and so a failure to fit it names the observation and nothing else, and that a supervised fit computes a gradient and therefore escapes the alignment law that caps the trainable count of the present trainer. The record would bind the label to the outcome rather than to a teacher or to a return under a weighting, and would bind the fit to the control plane. ADR-0192 D1 gives the competing rule, which reads a window of controller commands as the label. The report gives the reasoning and the measurement that would kill the claim | Proposed | 0001, 0154, 0176, 0192, 0195, 0196 | 43 |
| 0199 | A verb names a place by a cell of the egocentric frame the observation publishes. Changes ADR-0184 D3 and replaces it: that clause forbids every place, and it does so on the premise that a place is an index into the world extent. A cell of the egocentric frame is bounded by a constant, so the premise does not reach it. The constraint underneath D3 stands, and every other decision of ADR-0184 stands | Draft | 0004, 0040, 0075, 0144, 0154, 0176, 0184, 0192, 0195 | `draft/adr-0199-a-verb-names-a-place-by-a-cell-of-the-egocentric-frame.md` |
| 0200 | A stored policy names each row of the action table by its verb and its candidate coordinates, and the loader rebuilds the readout by that identity. Changes the ADR-0154 consequence that a learner stops when a stored policy states another action layout version, for the action table alone; the observation half of that consequence and every decision of ADR-0154 stand. Extends ADR-0176 D1, which makes the schema the only declaration of the table and states no rule for a file that outlives one | Draft | 0154, 0176, 0184, 0195, 0199 | `draft/adr-0200-a-stored-policy-names-each-action-row-by-verb-and-coordinates.md` |
| 0201 | A policy attends over the entity tokens, and reads the ring stack by a shared kernel. Extends ADR-0195 D4, which requires a reader to treat a token set as a set and names no reader that meets the requirement; every decision of ADR-0195 stands. Extends ADR-0002 D4 for the control plane, which admits a floating point number outside simulated state and states no rule for a value a policy returns to the engine | Draft | 0001, 0002, 0154, 0176, 0195, 0196, 0200 | `draft/adr-0201-a-policy-attends-over-the-entity-tokens.md` |
| 0202 | A run selects on the win share, and every published figure names its seed set. Extends ADR-0196, which states what a reward is and states no rule for which quantity chooses a centre or for how a run reports one. Every decision of ADR-0196 stands, and the shaped return it defines stays the training signal | Draft | 0001, 0154, 0194, 0195, 0196 | `draft/adr-0202-a-run-selects-on-the-win-share-and-every-published-figure-names-its-seed-set.md` |
| 0203 | A storm destroys a site only by driving its condition to nothing, and it harms the world through the sinks that already exist. Extends ADR-0140, which makes weather a field over the cell lattice and states no rule for what that field takes from the world; every decision of ADR-0140 stands | Draft | 0001, 0002, 0003, 0004, 0006, 0014, 0023, 0090, 0140, 0143, 0151, 0164 | `draft/adr-0203-a-storm-destroys-a-site-only-by-driving-its-condition-to-nothing.md` |
| 0204 | Every win path holds a bar of its own, and the tick limit ends a game with no winner. Changes ADR-0148 D3, which states that the territory reader fires at the tick limit and that the faction with the most held tiles wins; every other clause of ADR-0148 D3 stands. Extends ADR-0148 D1, which holds a record of a winner and states no outcome for a game that nobody wins | Draft | 0001, 0002, 0059, 0148, 0150, 0164, 0174, 0175, 0181, 0195, 0202 | `draft/adr-0204-every-win-path-holds-a-bar-of-its-own.md` |
| 0205 | Two factions meet when a unit has line of sight to another unit or a city. Extends ADR-0146, which makes a faction relation one signed integer and states no contact condition; every decision of ADR-0146 stands. Extends ADR-0144, which directs faction controllers through verbs; every decision of ADR-0144 stands | Draft | 0001, 0002, 0004, 0059, 0144, 0146, 0164 | `draft/adr-0205-two-factions-meet-when-a-unit-has-line-of-sight-to-another-unit-or-a-city.md` |
| 0206 | A part-built wonder decays when nobody works it, and resets when its ground changes holder. Changes ADR-0150 D4, whose last paragraph keeps the progress of a build whose ground changed hands; that clause stands for every row that carries no victory claim. Extends ADR-0174, whose D1 reads a finished wonder and states no rule for the work toward one | Draft | 0001, 0002, 0004, 0023, 0090, 0150, 0151, 0164, 0174, 0180, 0181 | `draft/adr-0206-a-part-built-wonder-decays-when-nobody-works-it.md` |
