...
[^item491]: Backlog item 0491, seed the demonstration world with unit types that can fight, gather and carry. `docs/backlog/proposed/0491-seed-the-demonstration-world-with-unit-types-that-can-fight-gather-and-carry.md`
