...
[^11]: Backlog item 0181, give a kind of work the commodity it fills. `docs/backlog/complete/0181-give-a-kind-of-work-the-commodity-it-fills.md`
...
[^20]: Backlog item 0279, let a golden scenario reach the position pass. `docs/backlog/complete/0279-let-a-golden-scenario-reach-the-position-pass.md`
