...
- D1, one answer serves a cell and a bucket. **Contradicted as written.** The
  ...
  bucket no longer share an answer. ADR-0107 states the widened key, and D1 of
...
- D3, a field indexed by the faction multiplies the world by the faction count,
  ...
  faction.[^7] ADR-0108 states that distinction, because a reader who knows
...
- **ADR-0107**, the choice key holds a bounded class of the unit's own state.
- **ADR-0108**, a unit returns by climbing a reach field seeded at every site of
  its faction.
...
[^12]: Decisions register, DEC-112. `docs/DECISIONS.md`
