...
**Creates.** ADR-0097. Quantising a need is a decision that ADR-0096 does not
...
and each bucket, ADR-0097 is written at `Draft`, and the reference table holds
...
[^7]: ADR-0097, the choice is decided for each cell and each bucket of need. `docs/adrs/draft/adr-0097-the-choice-is-decided-for-each-cell-and-each-bucket-of-need.md`
[^8]: Testing rules, section 2a. `.claude/rules/testing.md`
[^9]: Findings register, FND-258. `docs/FINDINGS.md`
[^10]: Backlog item 0242, decide whether the choice interval can go. `docs/backlog/proposed/0242-decide-whether-the-choice-interval-can-go.md`
