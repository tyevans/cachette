...
[^5]: ADR-0158, a site builds a typed unit from a bounded queue its store pays for. `docs/adrs/accepted/adr-0158-a-site-builds-a-typed-unit-from-a-bounded-queue-its-store-pays-for.md`
