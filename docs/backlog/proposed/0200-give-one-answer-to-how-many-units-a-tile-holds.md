...
- Which caller, if any, changes. The recommendation changes the fold and the
  comment on the composition, and no caller. It must still answer the drawing
  pass, because a false marker is what a watcher sees.
...
- Whether the record that governs the composition needs its own change. A
  ...
  second confirms the correction.[^5] [^6]
...
[^6]: Review 0204, the two corrected records. `docs/reviews/0204-the-two-corrected-records.md`
