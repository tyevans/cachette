...
[^3]: ADR-0153, a tile's lease follows the units that stand on it, decisions D6 and D7. `docs/adrs/draft/adr-0153-a-tiles-lease-follows-the-units-that-stand-on-it.md`
