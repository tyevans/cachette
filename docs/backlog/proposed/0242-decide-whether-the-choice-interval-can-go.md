...
[^2]: ADR-0097, the choice is decided for each cell and each bucket of need, decisions D1 and D3. `docs/adrs/draft/adr-0097-the-choice-is-decided-for-each-cell-and-each-bucket-of-need.md`
