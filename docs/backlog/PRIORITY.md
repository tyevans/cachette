...
| 0475 | Pass 4. An upgrade lasts forever, so a road is a fact and not a possession. It sits first among the passes because a hostile unit is defined by the war band that 0474 added, and it touches `fn step`, which 0474 has released. BLK-036 may touch it. |
