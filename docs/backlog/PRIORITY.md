...
| 0482 | Pass 6, the controller half. A faction that holds a board never writes to it. It sits under 0476 because it writes the board that the engine half, item 0477, added, and it waits for the controller stage of 0472 and the band of 0474. BLK-036 governs the land kind. |
| 0478 | Pass 7. A faction at war does nothing about it. It sits beside 0482 because it reads the band of 0474 and the soldier row of 0473 and adds no stage. |
| 0479 | Pass 8. Only one win path exists after 0472, and it fires only at the tick limit. It sits beside 0482 and 0478 because it adds no stage. BLK-150 governs the renown reader. |
| 0483 | A site closes every position once its store passes the default target, and the census reads the result as empty seats. FND-483 holds the reading. It sits under 0479 because the domination reader of 0479 counts held seats, and a seat count that reaches zero for want of a target makes that reader fire on nothing. BLK-050 governs the target value. |
