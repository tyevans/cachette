...
|---|---|---|
| ADR-0017 | `docs/adrs/accepted/adr-0017-the-world-is-a-rhombus-so-a-tile-index-is-raw-axial.md` | Implemented by `crates/cachette-core/src/hex.rs` and `crates/cachette-core/src/world/` |
