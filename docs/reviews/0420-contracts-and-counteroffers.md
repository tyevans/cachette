...
[^2]: ADR-0120, a trade negotiation is engine state, and the words are not. `docs/adrs/draft/adr-0120-a-trade-negotiation-is-engine-state.md`
[^3]: ADR-0121, a terminal refusal closes an ordered pair until a named tick. `docs/adrs/draft/adr-0121-a-terminal-refusal-closes-a-pair-until-a-named-tick.md`
[^4]: ADR-0122, a contract moves a quantity only when a unit carries it onto the ground of the other party. `docs/adrs/draft/adr-0122-a-contract-moves-a-quantity-only-when-a-unit-carries-it.md`
