...
- **Blockers.** BLK-035 resolved. No new row opened. The one thing that is
  ...
  holds information.[^3]
- **Decisions.** DEC-117 opened and closed in one change: the publishing job
  ...
  exists.
- **Findings.** FND-334 and FND-335.[^5]
...
[^5]: Findings register, FND-334 and FND-335. `docs/FINDINGS.md`
...
[^7]: Decisions register, DEC-117 and DEC-115. `docs/DECISIONS.md`
