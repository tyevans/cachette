...
One finding was added to the findings register, numbered FND-316.[^4]
...
reads, and the example calls both. FND-316 records the correction.[^4] The
...
[^4]: Findings register, FND-316. `docs/FINDINGS.md`
