...
| 0021 | A developer can use the control plane without reading its source | Shaped | Game developer | `shaped/prd-0021-a-developer-can-use-the-control-plane-without-reading-its-source.md` |
