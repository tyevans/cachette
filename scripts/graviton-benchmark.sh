...
case "$PROFILE" in
    full | quick) ;;
    one | stages | placement | memory-placement | collapse | exitfield | arena-order | reorder-cost)
...
if [ "$1" = "one" ] || [ "$1" = "stages" ] || [ "$1" = "placement" ] || [ "$1" = "memory-placement" ] || [ "$1" = "collapse" ] || [ "$1" = "exitfield" ] || [ "$1" = "arena-order" ] || [ "$1" = "reorder-cost" ]; then
