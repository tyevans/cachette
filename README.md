...
The contribution guide explains the layout, the testing policy, and how to
add each kind of test.[^1] The decision records hold the reasoning behind
the engine, and the product records hold the needs it answers to.[^2]

## References

[^1]: Contribution guide. `CONTRIBUTING.md`
[^2]: Decision records and product records. `docs/adrs/` and `docs/product/`
