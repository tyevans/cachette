...
class SiteHousing(TypedDict):
    """The housing of one site, and how full it is.

    The housing is a quantity of housing and not a count of people. The
    people it holds is that quantity divided by the housing one person
    takes.

    The free places are the people the housing holds, less the residents. A
...
class FrameReading(TypedDict):
    ...
    # The overlay the frame drew: its name, the value at which it draws no
...
class ArenaMismatchError(ViewError): ...
...
class World:
    def __init__(
        ...
        latitude_centre: int | None = ...,
        latitude_span: int | None = ...,
    ) -> None: ...
    @property
    def seed(self) -> int: ...
    @property
    def latitude_centre(self) -> int: ...
    @property
    def latitude_span(self) -> int: ...
    @property
    ...
    def has_met(self, from_faction: int, to_faction: int) -> bool: ...
    def meet(self, a: int, b: int) -> None: ...
    def set_met(self, a: int, b: int, met: bool) -> bool: ...
    ...
    def faction_overmatch_ratio(self, faction: int) -> int: ...
    def set_faction_overmatch_ratio(self, faction: int, raw: int) -> None: ...
    def set_overmatch_ratio(self, raw: int) -> None: ...
    @property
    ...
    def storm_depths(self) -> npt.NDArray[np.int32]: ...
    @property
    def storm_depth_whole(self) -> int: ...
    ...
    def settle_refusals(self, faction: int) -> list[str]: ...
    def settler_count(self, faction: int) -> int: ...
    ...
    def clear_projects(
        self, faction: int, addresses: Sequence[tuple[int, int]]
    ) -> int: ...
    def plan(self, faction: int) -> list[tuple[int, int, int]]: ...
    def set_plan_rules(
        self,
        bound: int,
        solver_passes: int,
        projects_per_pass: int,
        path_passes: int,
        radius: int,
    ) -> None: ...
    def project_at(self, faction: int, q: int, r: int) -> int | None: ...
    ...
    def unit_seeing_factions(self, unit: int) -> int: ...
    def unit_is_seen_by(self, unit: int, faction: int) -> bool: ...
    @property
    ...
    def encode_action(self, verb: str, arguments: list[int] = ...) -> int: ...
    def decode_action(self, action: int) -> tuple[str, list[int]]: ...
    ...
    def births(self) -> int: ...
    @property
    def housing_per_person(self) -> int: ...
    def set_housing_per_person(self, housing: int) -> None: ...
    def set_birth_chance(self, chance: int) -> None: ...
    def set_growth_schedule(self, period: int, phase: int) -> None: ...
    def set_food_per_birth(self, quantity: int, commodity: int = ...) -> None: ...
    ...
    @staticmethod
    def luxury_ceiling() -> int: ...
    def luxuries_at(self, tile: int) -> int: ...
    def variety_at(self, tile: int) -> int: ...
    @property
    def world_variety(self) -> int: ...
    @property
    def luxury_deposits(self) -> int: ...
    @property
    ...
    def set_settlement_store(
        self, sites: Identities, quantity: int, commodity: int = ...
    ) -> None: ...
    def set_economy_schedule(self, period: int, phase: int) -> None: ...
    def recovery_rules(self) -> list[int | None]: ...
    def set_recovery_rules(self, periods: Sequence[int | None]) -> None: ...
    def deed_threshold(self) -> int: ...
    def set_deed_threshold(self, threshold: int) -> None: ...
    def set_home_site(self, units: Identities, site: int | None = ...) -> None: ...
    def set_influence_source(
        self, faction: int, addresses: Sequence[tuple[int, int]], source: int
    ) -> None: ...
